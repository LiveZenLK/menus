...
class Menus {
     ...
     *
     * @param  string $menu_name The name of the menu file to read.
     *
     * @return array            The complete structure of the menu.
     */
    public function buildMenu($menu_name, $menu_folder=null)
    {
        $menu = $this->readMenu($menu_name, $menu_folder);
     ...
     * with our params.
     *
     * @param  array $structure  The menu structure
